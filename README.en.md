...
![Demo: switch providers, then go back to official OpenAI](docs/demo.gif)

<sub>The clip uses demo data generated by the screenshot script (fake keys, a local fake
balance endpoint) — it is nobody's real account.</sub>
